...
public class AepUnsafe extends GridUnsafe {
     ...
     */
    @Override
    public boolean compareAndSwapInt(Object obj, long offset, int exp, int upd) {
        return obj != null ? UNSAFE.compareAndSwapInt(obj, offset, exp, upd) : compareAndSwapInt(offset, exp, upd);
    }
     ...
     */
    @Override
    public boolean compareAndSwapLong(Object obj, long offset, long exp, long upd) {
        return obj != null ? UNSAFE.compareAndSwapLong(obj, offset, exp, upd) : compareAndSwapLong(offset, exp, upd);
    }
     ...
     * @return
     */
    public synchronized boolean compareAndSwapInt(long offset, int exp, int upd) {
        if (getInt(offset) == exp) {
            putInt(offset, upd);
            return true;
        }
        return false;
     ...
     * @return
     */
    public synchronized boolean compareAndSwapLong(long offset, long exp, long upd) {
        if (getLong(offset) == exp) {
            putLong(offset, upd);
            return true;
        }
        return false;
