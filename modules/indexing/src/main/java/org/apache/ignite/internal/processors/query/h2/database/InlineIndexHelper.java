...
public class InlineIndexHelper {
    ...
    private int compareAsBytes(long pageAddr, int off, Value v) {
        ...
        if (compareBinaryUnsigned) {
            for (int i = 0; i < len; i++) {
                int b1 = GridUnsafe.getInstance().getByte(addr + i) & 0xff;
                int b2 = bytes[i] & 0xff;
            ...
            for (int i = 0; i < len; i++) {
                byte b1 = GridUnsafe.getInstance().getByte(addr + i);
                byte b2 = bytes[i];
    ...
    private int compareAsString(long pageAddr, int off, Value v, boolean ignoreCase) {
        ...
        while (cntr1 < len1 && cntr2 < len2) {
            c = (int) GridUnsafe.getInstance().getByte(addr) & 0xFF;
        ...
        while (cntr1 < len1 && cntr2 < len2) {
            ...
            switch (c >> 4) {
                ...
                /* 110x xxxx   10xx xxxx*/
                    ...
                    c2 = (int) GridUnsafe.getInstance().getByte(addr++) & 0xFF;
                ...
                /* 1110 xxxx  10xx xxxx  10xx xxxx */
                    ...
                    c3 = (int) GridUnsafe.getInstance().getByte(addr++) & 0xFF;
                ...
                /* 11110xxx 10xxxxxx 10xxxxxx 10xxxxxx */
                    ...
                    c4 = (int) GridUnsafe.getInstance().getByte(addr++) & 0xFF;
